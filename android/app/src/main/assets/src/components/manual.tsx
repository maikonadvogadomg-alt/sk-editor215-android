        ...
        const tabContent: Record<string, React.ReactNode> = {
              ...
              <div className="bg-[#0d1309] border border-[#2d4a1e] rounded-lg p-4 mb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="https://meu-servidor.app"
          ...
          "android-pwa": (
            <div>
              ...
              <H2>📋 Pré-requisito</H2>
              <P>O app precisa estar <strong className="text-[#7ec87a]">publicado</strong> com uma URL pública (ex: seu-servidor.app). Veja a aba "Guia Universal" para publicar.</P>
              ...
              <ol className="mb-4">
                ...
                <Step n={2}>Acesse a URL do seu app publicado<br/><span className="text-[#5aab56] font-mono text-xs">ex: https://meu-servidor.app</span></Step>
          ...
          "bubblewrap": (
            <div>
              ...
              <Code copyKey="bw-init">{`bubblewrap init --manifest https://SEU-SERVIDOR.app/manifest.json`}</Code>
...
{
  "packageId": "app.meuapp.android",
  "host": "meu-servidor.app",
  "name": "Meu App",
  "launcherName": "MeuApp",
  "display": "standalone",
  "themeColor": "#1a237e",
  ...
  "startUrl": "/",
  "iconUrl": "https://meu-servidor.app/icon-512.png",
  "maskableIconUrl": "https://meu-servidor.app/icon-512.png",
  "signingKey": {
    ...
    "alias": "android"
          ...
          "universal": (
            <div>
              <Alert color="green">
                🌐 <strong>Este guia se aplica a QUALQUER projeto web.</strong> Siga os passos abaixo para transformar qualquer app web em app no celular.
              </Alert>

              <H2>📋 PASSO 1 — Escolha sua forma de publicar</H2>
              <div className="grid grid-cols-1 gap-2 mb-4">
                {[
                  { plano: "Free (Gratuito)", ok: "PWA via Chrome/Safari ✅", nok: "URL temporária", rec: "Funciona para uso pessoal" },
                  { plano: "Hacker / Pro", ok: "Domínio próprio fixo ✅", nok: "—", rec: "Recomendado para apps sérios" },
              ...
              <H2>🚀 PASSO 2 — Publicar o app online</H2>
              <ol className="mb-4">
                <Step n={1}>Abra seu projeto no <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[#6ab4ff] underline">github.com</a></Step>
                ...
                <Step n={5}>Configure o domínio personalizado (ou use o subdomínio gerado automaticamente)</Step>
                <Step n={6}>Clique em <strong>"Deploy"</strong> e aguarde</Step>
                <Step n={7}>Copie a URL gerada — ex: <code className="text-[#a8d5a2] font-mono text-xs">https://meu-servidor.app</code></Step>
              </ol>
              ...
              <div className="space-y-2 mb-4">
                {[
                  ...
                  ["HTTPS", "HTTPS configurado automaticamente", "automático"],
                ].map(([item, desc, req]) => (
              ...
              <Alert color="blue">
                💡 O SK Code Editor já tem manifest.json, sw.js e ícones prontos. Para outros projetos, peça para a Jasmim: "Adicione PWA neste projeto com manifest.json e service worker".
              </Alert>
              ...
              <P>Para cada app que você tiver publicado, repita estes passos:</P>
              <ol className="mb-2">
                {[
...
# 3. O preview vai aparecer na porta configurada`}</Code>
      ...
      content: (
        <div>
          ...
          <ul className="space-y-1 mb-3">
            ...
            <Li>Projetos do VS Code, GitHub, Glitch e outros são compatíveis</Li>
          </ul>
...

    {
      ...
      content: (() => {
        const tabs = [
          { id: "importar",  label: "Importar Projeto", icon: "⬇️" },
        ...
        const tabContent: Record<string, React.ReactNode> = {
          ...
          "importar": (
            <div>
              <Alert color="blue">
                ⬇️ <strong>Você não precisa recriar nada.</strong> Seus projetos chegam aqui prontos — código, arquivos e tudo mais. Escolha o método abaixo.
              </Alert>

              <H2>📦 MÉTODO 1 — Via ZIP (mais fácil)</H2>
              <P>Qualquer projeto pode ser exportado como ZIP em segundos.</P>
              <ol className="mb-4">
                <Step n={1}>Abra o projeto no <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[#6ab4ff] underline">GitHub</a></Step>
              ...
              <ol className="mb-4">
                <Step n={1}>Vá em <strong>Version Control</strong> e conecte ao GitHub se ainda não fez</Step>
          ...
          "desktop": (
            <div>
              ...
              <ol className="mb-4">
                ...
                <Step n={2}>Acesse a URL do app publicado: <span className="font-mono text-[#a8d5a2] text-xs">https://seu-servidor.app</span></Step>
              ...
              <div className="grid grid-cols-1 gap-2 mb-4">
                {[
                  ...
                  ["♻️ Atualização automática", "Quando o app no servidor é atualizado, a instalação já pega a versão nova"],
                ].map(([título, desc]) => (
            ...
            <div>
              ...
              <ol className="mb-4">
                ...
                <Step n={2}>
                  ...
                  Use a aba "Importar Projeto" — ZIP ou GitHub. Anote o nome das pastas.
                </Step>
                <Step n={3}>
          ...
          "orientar": (
            <div>
              ...
              <P>Antes de qualquer coisa, faça uma lista rápida. Para cada app seu:</P>
              <div className="bg-[#0d1309] border border-[#2d4a1e] rounded-lg p-4 mb-4">
...
- Notificações ❌ (não existe em nenhum, precisa criar)`}</Code>
              ...
              <P>Importe os apps que têm as partes que funcionam (veja a aba "Importar ZIP"). Você não precisa trazer todos — só os que têm algo útil.</P>
...
O app final deve ter: [LISTE AS FUNCIONALIDADES QUE VOCÊ QUER]"</Code>
              ...
              <ol className="mb-4">
                <Step n={1}>Com o projeto único funcionando, publique online (GitHub Pages, Vercel, etc.)</Step>
                <Step n={2}>Copie a URL gerada do seu servidor</Step>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  ["3️⃣", "Publica online (GitHub Pages, Vercel, etc.)"],
                  ["4️⃣", "Instala no celular como PWA ou APK"],
                  ["5️⃣", "Usa com privacidade, sem depender de terceiros para abrir"],
                ].map(([n, t]) => (
